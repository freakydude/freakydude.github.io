...
1. Basic install and configure Mainsail
   ...
   - But you have a lucky day. I created a printer.cfg for the Sidewinder X2. Download it here: [printer.cfg](https://github.com/freakydude/klipper/blob/swx2-example/config/printer-artillery-sidewinder-x2-2022.cfg).   
